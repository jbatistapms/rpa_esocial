...
from .tipos import TIdeEmpregador, TIdeEventoFolha
...
class TInfoAgNocivo:
    ...
    grau_exp: Optional[str] = field(
        ...
        metadata={
            "name": "grauExp",
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtRemun/v_S_01_01_00",
            "required": True,
        }
    )
...
class Evento:
    ...
    class Meta:
        name = "eSocial"
        namespace = "http://www.esocial.gov.br/schema/evt/evtRemun/v_S_01_01_00"
        schema = "esquemas_xsd_s_1_1/evtRemun.xsd"
